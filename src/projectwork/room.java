...
public class room extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SERIAL_NUMBER");

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jPanel1.setBackground(new java.awt.Color(0, 0, 0));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ROOM_AVAILABLE", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Trebuchet MS", 3, 24), new java.awt.Color(0, 102, 255))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int room_no,total_seats,seats_occupied,seats_left;
        ...
        try
        {
          ...
          statement=connection.prepareStatement("insert into room(room_no,total_seats,seats_occupied,seats_left) values(?,?,?,?)");
          
          
          room_no=Integer.parseInt(jTextField2.getText());
          total_seats=Integer.parseInt(jTextField3.getText());
          seats_occupied=Integer.parseInt(jTextField4.getText());
          seats_left=total_seats-seats_occupied;
          jTextField5.setText(String.valueOf(seats_left));
          
          
          statement.setInt(1,room_no);
          statement.setInt(2,total_seats);
          statement.setInt(3,seats_occupied);
          statement.setInt(4,seats_left);
